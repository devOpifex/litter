"use strict";(self.webpackChunklitter=self.webpackChunklitter||[]).push([[547],{650:(t,e,s)=>{var i=s(392);s(235),s(311);class r extends i.oi{static get styles(){return i.iv`input{
			...
			.value='${this.value}'>`}}window.customElements.define("litter-text",r),window.Shiny.addCustomMessageHandler("litter-text-input",(t=>{t.props.length>0&&$(t.selector).attr("props",JSON.stringify(t.props)),t.value&&$(t.selector).attr("value",t.value)}))},235:t=>{t.exports=Shiny},311:t=>{t.exports=jQuery}},t=>{t.O(0,[560],(()=>(650,t(t.s=650)))),t.O()}]);